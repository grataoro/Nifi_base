try:
    ...
    url_opt = "https://api.pipe.run/v1/deals?created_at_start="+day_1+"&with=users&show=200&page={}"
    ...
    pg("polichat").exec_pgsql("delete from piperun.deals where created_at >'{}'".format(day))
